...
import { yearlyVaneuReservationsData } from '../../data/charts';

const YearVanueReservations = ({ className = '', controls = true }) => {
  return (
    <Card className={`${className} dashboard-filled-line-chart`}>
      ...
      <div className="chart card-body pt-0">
        <AreaChart shadow data={yearlyVaneuReservationsData} />
      </div>
    </Card>
  );
};

export default YearVanueReservations;
