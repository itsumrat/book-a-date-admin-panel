          ...
          <CardBody>
            <Row>
              ...
              <Colxx xxs="12" className="mb-3">
                ...
                <CardText>
                  End: {moment(product.advertiseEnd).format('ddd, MMM Do YYYY')}
                </CardText>
              </Colxx>
              <Colxx xxs="12" className="mb-3">
                <CardText>
                  Start: {moment(product.advertiseStart).format('h:mm:ss a')}
                </CardText>
                <CardText>
                  End: {moment(product.advertiseEnd).format('h:mm:ss a')}
                </CardText>
              </Colxx>
